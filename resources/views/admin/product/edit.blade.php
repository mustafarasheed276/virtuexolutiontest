				...
				<div class="card">
					<div class="card-body">								
						<div class="row">
							...
							<input type="hidden" name="image" id="imageIds">
							<div class="col-md-6">
								<div class="mb-3">
...
const dropzone = $("#image").dropzone({ 
    init: function() {
    	@foreach ($productImages as $imageName)
           var mockFile = { name: '{{ $imageName->filename }}', size: 250 }; // You can set size to 0 or any other appropriate value
           var imagePath = '/uploads/gallery/' + '{{ $imageName->filename }}'; // Adjust the path as per your folder structure
